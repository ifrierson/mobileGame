window.addEventListener('load', function () {
    ...
    class InputHandler {
        constructor() {
            this.keys = [];
            // making the touch threshold atleast x number of pixels apart to trigger event
            this.touchY = '';
    ...
    class Player {
        ...
        draw(context) {
            // Uncomment to show player hit box
            // context.lineWidth = 5;
        ...
        update(input, deltaTime, enemies) {
            ...
            enemies.forEach(enemy => {
                const dx = (enemy.x + enemy.width / 2 - 30) - (this.x + this.width / 2);
    ...
    class Enemy {
        ...
        draw(context) {
            // Uncomment to show enemy hitbox
            // context.lineWidth = 5;
            // context.strokeStyle = 'white';
            // context.beginPath();
            // context.arc(this.x + this.width / 2 - 30, this.y + this.height / 2, this.width / 3, 0, Math.PI * 2);
            // context.stroke();
